// database lies in different continent
// it takes time to connect database that's why we use async await
// sometimes failed to connect to database taht's why we use try catch
